                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li>
                                <a class="active" href="/?act=profile"><i class="fa fa-user"></i> <?= $username; ?> </a>
                            </li> 
                        </ul>        
            ...
            <div class="user-form">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <input name="email" type="email" class="form-control" value="<?= $username?>" disabled>
                    </div>
                    <div class="form-group">
                        <input name="username" type="text" class="form-control" value="<?= $username?>" disabled>
                    </div>
                    <div class="form-group">
                        <input name="phone" type="number" class="form-control" value="<?= $phone ?>" disabled>
                    </div>
                    <div class="form-group main-button">
                        <a href="/?act=profil-edit" class="btn-block">EDIT PROFIL</button>
                        <a href="/?act=logout" class="btn-block">KELUAR</button>
                    </div>
                    <footer>
