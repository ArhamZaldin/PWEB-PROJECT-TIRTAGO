...
<html lang="en">
    ...
    <title>Ubah Profil | TIRTAGO</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- Logo Start -->
                        <a href="index.php" class="logo">TIRTA<em>GO</em></a>
                        <!-- Logo End -->
                        <!-- Menu Start -->
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="/?act=pesan-air">Pemesanan Air Galon</a>
                            ...
                            <li>
                                <a class="active" href="/?act=profil"><i class="fa fa-user"></i> <?= $username; ?></a>
                            </li> 
                        </ul>        
            ...
            <div class="user-form">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <input name="email" type="email" class="form-control" value="<?= $username; ?>" required>
                    </div>
                    <div class="form-group">
                        <input name="username" type="text" class="form-control" value="<?=$username;?>" required>
                    </div>
                    <div class="form-group">
                        <input name="phone" type="number" class="form-control" value="12345" required>
                    </div>
                    <div class="form-group">
                        <input name="password" type="password" class="form-control" placeholder="Password" minlength="6" required>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="main-button btn-block">Simpan</button>
                    </div>
                    <div class="form-group main-button">
                        <a href="/?act=profil" class="btn-block">Batal</button>
                    </div>
