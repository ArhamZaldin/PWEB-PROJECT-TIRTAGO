...
<html lang="en">
  ...
  <head>
    ...
    <title>Petunjuk Pemesanan Air Galon | TIRTAGO</title>
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="/?act=petunjuk-pesan-air">Pemesanan Air Galon</a>
                                </div>
                            <li class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <br>
                        <br>
                        <h2>Petunjuk Pemesanan Air Galon TIRTA<em>GO</em></h2>
                        <p>Untuk mempermudah proses pemesanan air galon, silakan masuk terlebih dahulu.</p>
                        <div class="main-button">
                            <a href="/?act=login">masuk</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="feature-item">
                        ...
                        <div class="right-content">
                            <h4>Masuk ke dalam website TIRTA<em>GO</em> menggunakan akun Anda. Jika belum punya, silakan mendaftar terlebih dahulu.</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="feature-item">
                        ...
                        <div class="right-content">
                            <h4>Klik menu <strong>Layanan</strong>, kemudian akan muncul dropdown dan pilih <strong>pemesanan air galon</strong>.</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
